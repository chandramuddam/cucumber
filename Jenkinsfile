node() {
	...
	stage('Import results to Xray') {
		...
		def info = '''{
			...
			step([$class: 'XrayImportBuilder', endpointName: '/junit/multipart', importToSameExecution: 'false', inputInfoSwitcher: 'filePath', serverInstance: 'server-a3cb4d89-7abd-4ee8-aebd-51b8e0244a44'])
		}
}
